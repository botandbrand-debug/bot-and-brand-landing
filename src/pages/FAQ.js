  ...
  return (
    <section className="fadeInUp bg-background text-foreground py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-[#00ffff] to-[#39ff14] text-transparent bg-clip-text">
          Frequently Asked Questions
        </h2>
        <div className="w-24 h-1 mx-auto bg-gradient-to-r from-[#00ffff] to-[#39ff14] rounded-full mb-8" />
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <span className="text-[#00ffff] dark:text-[#39ff14] transition-transform duration-300">
                  {openIndex === index ? (
